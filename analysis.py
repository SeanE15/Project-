...
# I also wrote below a different output which looks to me more appealing that the simple hsitograms - I create a distplot instead of a histplot above. I liek the look of the dist plot better
...
# This is shown below and throughout the program above. I also noticed that in the previou8s itteration of the program I had mislabeled the 'Type' with capital Letters instead of lower case.
# This had been throwing off the results fo my scatter plot, once rectified the results came out correct. This hadn't been an issue previously as the information for the histograms was 
# comign from the entire 'iris' dataset instead of individual 'type' subheadings.  

sns.scatterplot(data = iris_setosa , x= "Sepal Length", y = "Sepal Width", style = "Type")
plt.show()
